...
## Pre-processing and algorithm code for section4:
For the results shown in section 4, the code used to access both the function f0 and the DE algorithm is designed in the SOS-platform, with the full code and reproduction steps avaialble at https://github.com/facaraff/SOS/releases/tag/ECJ-ReproducibilityInEC
...
## Presentation code for section 4:
...
For the results shown in section 5, the code used to access the function-instances is IOHexperimenter, specifically version "ioh==0.3.2.4" used with python 3.8.10. All experimental conditions and scripts used for parameter settings are integraded directly in the algorithm code
